...
- **Computed Fields**: `derivedValue` can auto-calculate fields (e.g., expiration date = prep date + 2 days), prefill DATE fields with today, or map time-of-day into a default value, and keep them hidden/system-managed.
