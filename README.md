...
- **Create/Copy UX (per form)**: Customize Create/Copy labels via `"createButtonLabel"` / `"copyCurrentRecordLabel"`, and control copied data via `"copyCurrentRecordDropFields"` (blacklist) or `"copyCurrentRecordProfile"` (whitelist).
