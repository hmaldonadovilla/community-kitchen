...
- Prefer: install triggers via **Community Kitchen → Install Triggers (Options + Response indexing)** so manual edits automatically bump `Data Version` + etags, and daily analytics reconciliation runs.
