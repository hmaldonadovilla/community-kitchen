...
const resolveServerCurrentRecordReservedQuantityFromRow = (
...
const buildAutoGeneratedChildRows = (args: {
  subGroupId: string;
  ...
  return args.entries.map((entry, index) => {
    ...
    const childRowId = reusableId || `${args.subGroupId}_${Math.random().toString(16).slice(2)}`;
