...
/**
 * Owner: guided utilisation quantity visibility.
 * Resolves local and committed utilisation quantities from draft/output values
 * without depending on React state or data-source IO.
 */
export const resolveUtilisationQuantityFromValues = (
...
export const resolveLocalUtilisationQuantityForVisibility = (args: {
  ...
  const localQuantity = resolveUtilisationQuantityFromValues(
  ...
  return resolveUtilisationQuantityFromValues(
