...
export interface LineItemRowState {
  ...
  /**
   * Client-only marker for rows created in the current edit session.
   * This is intentionally not stored in row values or persisted to sheets.
   */
  localAddedAtMs?: number;
}
