...
// Contains exported form configurations embedded from /docs/config/exports/prod.

import type { FormConfigExport } from '../types';

export const BUNDLED_CONFIG_ENV = "prod" as const;
export const BUNDLED_FORM_CONFIGS = [
  {
    "formKey": "Config: Checklist",
    "generatedAt": "2026-01-31T21:33:14.877Z",
    "form": {
      ...
      "appUrl": "https://script.google.com/a/communitykitchen.be/macros/s/AKfycby1cbanNKRxdchniwHOuslbxZ5ozarPqhT3y0EEWlUu/exec?form=Config%3A%20Checklist",
      "formId": "https://script.google.com/a/communitykitchen.be/macros/s/AKfycby1cbanNKRxdchniwHOuslbxZ5ozarPqhT3y0EEWlUu/exec?form=Config%3A%20Checklist",
      "rowIndex": 5,
      "followupConfig": {
        "pdfTemplateId": {
          "cases": [
            {
              ...
              "templateId": {
                "EN": "1H2lIyvPr1FsgwvUWunbGv-WQZclRCvT7TexAPpGE7C8",
                "FR": "1H2lIyvPr1FsgwvUWunbGv-WQZclRCvT7TexAPpGE7C8"
              }
            },
            {
              "when": {
              ...
              "templateId": {
                "EN": "1RLK48OsDhNwsYSoaoDioXDUr9kImV2WmcVDUZ_2gYak",
                "FR": "1RLK48OsDhNwsYSoaoDioXDUr9kImV2WmcVDUZ_2gYak"
              }
            },
            {
              "when": {
              ...
              "templateId": {
                "EN": "1RWUJUqF60zuVnxoZiiDK1JT6smEQ1_DDYVc6csPNt-w",
                "FR": "1RWUJUqF60zuVnxoZiiDK1JT6smEQ1_DDYVc6csPNt-w"
              }
            },
            {
              "when": {
              ...
              "templateId": {
                "EN": "1b91r5PlXSG0mDtuO_ZLSh-VfeeEhqlOBMfiGN-ZdQt8",
                "FR": "1b91r5PlXSG0mDtuO_ZLSh-VfeeEhqlOBMfiGN-ZdQt8"
              }
            }
          ],
          "default": "1b91r5PlXSG0mDtuO_ZLSh-VfeeEhqlOBMfiGN-ZdQt8"
        },
        "pdfFolderId": "1Ktr2j-sL8lzrJxfGIWKZA09SCSiG6cHj",
        "emailTemplateId": {
          "EN": "1pPpcM4s0sSa1j89uwiS1y1Zbb2mxK35pZ2ouCqB4Fjs",
          "FR": "1pPpcM4s0sSa1j89uwiS1y1Zbb2mxK35pZ2ouCqB4Fjs"
        },
        "emailSubject": {
