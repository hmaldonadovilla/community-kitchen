import { shouldKeepInvalidSourceFirstQuantityDraft } from '../../../src/web/react/features/lineItems/domain/sourceFirstReservationDraftDecision';

describe('sourceFirstReservationDraftDecision', () => {
