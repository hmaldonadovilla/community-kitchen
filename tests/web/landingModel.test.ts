...
const landingConfigFixture: LandingPageConfig = {
  ...
  apps: [
    ...
    },
    {
      ...
      description: 'Track bank of ingredients and supplies.'
    },
    {
    ...
    },
    {
      ...
      description: 'Review internal bank utilisations generated by operations.'
    }
  ]
};
...
describe('landing model helpers', () => {
  ...
  test('buildLandingCatalogLayout maps the mockup copy and groups overflow admin forms', () => {
    expect(
      buildLandingCatalogLayout(
        [
          { formKey: 'Config: Leftover Utilisation', title: 'Leftover Utilisation', targetUrl: 'https://example.test/utilisation' },
          ...
          { formKey: 'Config: Leftover Bank', title: 'Leftover Bank', targetUrl: 'https://example.test/leftovers' }
        ] as any,
        true,
      ...
      adminApps: [
        ...
        },
        {
          ...
          displayDescription: 'Track bank of ingredients and supplies.',
          illustration: 'ingredients',
          imageUrl: 'data:image/jpeg;base64,ingredients'
        },
        {
      ...
      overflowAdminApps: [
        ...
        },
        {
          formKey: 'Config: Leftover Utilisation',
          title: 'Leftover Utilisation',
          targetUrl: 'https://example.test/utilisation',
          displayTitle: 'Leftover Utilisation',
          displayDescription: 'Review internal bank utilisations generated by operations.',
          illustration: 'admin',
          imageUrl: undefined
        }
      ]
