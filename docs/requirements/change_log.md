...
- ck-19: add placeholder on paragraphs
...
- add `source` sort type to the listViewSort config
- support placeholders in the email subject
- remove the translate stuff to english button on google sheet
