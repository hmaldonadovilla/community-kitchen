...
| Stage 2: Frontend/business logic separation | In progress | First slice extracts Home list local cache behavior from `App.tsx` into a focused module with targeted unit coverage. |
